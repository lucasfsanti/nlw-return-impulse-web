...
export function FeedbackContentStep({ feedbackType, onReturnButtonClicked, onFeedbackSent }: FeedbackContentStepProps) {
        ...
        <>
            <header>
                ...
                <span className="text-xl leading-6 flex items-center gap-2">
                    <img src={feedbackTypeInfo.image.source} alt={feedbackTypeInfo.image.alt} className="w-6 h" />
